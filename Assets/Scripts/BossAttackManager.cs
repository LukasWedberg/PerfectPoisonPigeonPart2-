...
public class BossAttackManager : MonoBehaviour
{
    ...
    private bool lastFunctionCall = false;
    ...
    void BeginAttacking(BossAttackType attackToDo)
    {
        ...
        switch(attackToDo){
            ...
            case BossAttackType.Madness:
                ...
                lastFunctionCall = true;
                firstFunctionCall = true;

                camAttackTime = 8888;
                sentryAttackTime = 8888;
                waveAttackTime = 8888;
    ...
    void EndAttacking()
    {
        ...
        onCurrentAttack = NotAttackingFunction;

        firstFunctionCall = true;

        lastFunctionCall = false;
    ...
    void FloodingFunction()
    {
        ...
        if ( Mathf.Abs(playerBossXDist) > 10)
        {
            ...
            targetWaveSpeed = 3*Mathf.Sign(playerBossXDist);
    ...
    public float targetWaveSpeed = 3;
