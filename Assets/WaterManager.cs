...
public class WaterManager : MonoBehaviour
{
    ...
    void Update()
    {
        currentWaterLevel = Mathf.Lerp(currentWaterLevel, targetWaterLevel, 3 * Time.deltaTime);

        currentAmplitude = Mathf.Lerp(currentAmplitude, targetAmplitude, 3 * Time.deltaTime);
